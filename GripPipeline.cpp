...
void GripPipeline::Process(cv::Mat& source0){
	...
	double hsvThresholdHue[] = {0.0, 94.97326203208557};
	double hsvThresholdSaturation[] = {0.0, 43.95051194539249};
	double hsvThresholdValue[] = {226.45764744136892, 255.0};
	...
	double filterContoursMinRatio = 0.8;  // default Double
